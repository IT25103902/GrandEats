...
import com.reservation.util.EmailUtility; // import Utility class
...
public class ForgotPasswordServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Generate 6-digit OTP (06d format)
        Random rand = new Random();
        String otp = String.format("%06d", rand.nextInt(999999));

        // Save email and OTP in session to verify
        ...
        try {
            ...
            // Call static method in EmailUtility
